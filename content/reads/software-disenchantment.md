...
summary: "The following is a rant on the low care for software performance in modern software development. It was written in 2018, but 5 years later, things have only got worse"
keywords: ['tonsky', 'software performance', 'bloat', 'rant']
date: 2023-03-15T21:19:07+0000
draft: false
categories: ['reads']
tags: ['reads', 'tonsky', 'software performance', 'bloat', 'rant']
---

The following is a rant on the low care for software performance in modern software development. It was written in **2018**, but 5 years later, things have only got worse.

There is this huge pitfall where "programmer time" is recognized as more valuable than computer time, which glorifying this statement only makes things worse.
...
{{< center-figure
    src="https://raw.githubusercontent.com/freitzzz/cinderela/master/blog/general/software-disenchantment/cover.webp"
    caption=""
    alt=``
...
{{< center-figure
    src="https://raw.githubusercontent.com/freitzzz/cinderela/master/blog/general/software-disenchantment/software_development_2x.gif"
    caption=""
    alt=``
    class="row flex-center"
>}}
...
{{< video src="https://raw.githubusercontent.com/freitzzz/cinderela/master/blog/general/software-disenchantment/inbox.mp4" type="video/mp4" preload="auto" >}}
>
...
{{< center-figure
    src="https://raw.githubusercontent.com/freitzzz/cinderela/master/blog/general/software-disenchantment/windows_update.gif"
    caption=""
    alt=``
    class="row flex-center"
>}}
...
{{< center-figure
    src="https://raw.githubusercontent.com/freitzzz/cinderela/master/blog/general/software-disenchantment/android_storage.webp"
    caption=""
    alt=``
    class="row flex-center"
>}}
...
{{< center-figure
    src="https://raw.githubusercontent.com/freitzzz/cinderela/master/blog/general/software-disenchantment/apps_storage.gif"
    caption=""
    alt=``
    class="row flex-center"
>}}
...
{{< center-figure
    src="https://raw.githubusercontent.com/freitzzz/cinderela/master/blog/general/software-disenchantment/slack_memory.webp"
    caption=""
    alt=``
    class="row flex-center"
>}}
...
{{< center-figure
    src="https://raw.githubusercontent.com/freitzzz/cinderela/master/blog/general/software-disenchantment/reload.webp"
    caption=""
    alt=``
    class="row flex-center"
>}}
...
{{< center-figure
    src="https://raw.githubusercontent.com/freitzzz/cinderela/master/blog/general/software-disenchantment/icloud_conflict.webp"
    caption=""
    alt=``
    class="row flex-center"
>}}
...
{{< center-figure
    src="https://raw.githubusercontent.com/freitzzz/cinderela/master/blog/general/software-disenchantment/plz_connect.webp"
    caption=""
    alt=``
    class="row flex-center"
>}}
...
{{< center-figure
    src="https://raw.githubusercontent.com/freitzzz/cinderela/master/blog/general/software-disenchantment/compiling.gif"
    caption=""
    alt=``
    class="row flex-center"
>}}
...
{{< center-figure
    src="https://raw.githubusercontent.com/freitzzz/cinderela/master/blog/general/software-disenchantment/python_environment_2x.gif"
    caption=""
    alt=``
    class="row flex-center"
>}}
...
{{< center-figure
    src="https://raw.githubusercontent.com/freitzzz/cinderela/master/blog/general/software-disenchantment/dependencies.gif"
    caption=""
    alt=``
    class="row flex-center"
>}}
...
{{< center-figure
    src="https://raw.githubusercontent.com/freitzzz/cinderela/master/blog/general/software-disenchantment/design_process.webp"
    caption=""
    alt=``
    class="row flex-center"
>}}
